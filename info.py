...
class Info(commands.Cog):
    ...
    async def _help(self, ctx):
        ...
        embedvar.add_field(name=')inventory', value='To view your shopping cart', inline=False)
        embedvar.add_field(name=')lb', value='To view leaderboard', inline=False)
        embedvar.add_field(name=')work', value='To work for money', inline=False)
        embedvar.add_field(name='Invite Link', value='Here is the bots invite link: https://discord.com/api/oauth2/authorize?client_id=916003775595040868&permissions=8&scope=bot', inline=False),
        embedvar.add_field(name=')Weekly, )Daily, )Hourly', value='Different Cooldowns', inline=False),
        embedvar.add_field(name=')Addmoney', value='Administrator Command Only - Adds 10k to your balance', inline=False),
